...
import org.mycocosm.framework.time.TimeIntervalFormat;
...
public enum StandardFormatters implements Formatter<Object>  {
	...
	TimeInterval {
		@Override
		public String format(Object o) {
			if (org.mycocosm.framework.time.TimeInterval.class.isAssignableFrom(o.getClass()) || Number.class.isAssignableFrom(o.getClass()) || Duration.class.isAssignableFrom(o.getClass())) {
	...
	public static final Formatter<Duration> DURATION = new Formatter<>() {
		...
		public String format(Duration o) {
			return TIME_INTERVAL_FORMAT.format(org.mycocosm.framework.time.TimeInterval.nullSafeFromDuration(o));
		}
	};
